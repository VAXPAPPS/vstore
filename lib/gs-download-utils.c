 ...
 *
 * Build a new #SoupSession configured with the vstore user agent.
 *
                  ...
                  gpointer      user_data)
{
	 ...
	 * modification time of the local file equals when vstore last
	 * checked for updates to it — which is correct to send as the
	 * If-Modified-Since the next time vstore checks for updates to
	 * the file. */
