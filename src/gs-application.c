		 ...
		 gpointer       user_data)
{
	...
	adw_show_about_window (app->main_window,
			       ...
			       "version", get_version(),
			       "website", "https://vaxp.os/vstore",
			       "support-url", "https://discourse.gnome.org/tag/vstore",
			       "issue-url", "https://gitlab.gnome.org/GNOME/vstore/-/issues",
			       "developers", developers,
			       "designers", designers,
			       "copyright", _("Copyright \xc2\xa9 2016–2023 Vstore contributors"),
	...
	gtk_about_dialog_set_copyright (dialog, _("Copyright \xc2\xa9 2016–2023 Vstore contributors"));
	...
	gtk_window_set_title (GTK_WINDOW (dialog), _("About Vstore"));
...
_copy_file_to_cache (GFile *file_src, GError **error)
{
	...
	cache_dir = g_dir_make_tmp ("vstore-XXXXXX", error);
	if (cache_dir == NULL)
		return NULL;
