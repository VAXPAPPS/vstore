...
suitable for inclusion with vstore. The goals of this initiative are:
...
There is more context available in the discussion on [this issue](https://gitlab.gnome.org/GNOME/vstore/-/issues/1575).
...
4. You can check the validity using e.g. `appstreamcli validate
   ...
   vstore handles those gracefully.
