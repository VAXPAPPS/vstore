 ...
 * component. For vstore specific app-like entries, which don't correspond to desktop
 ...
 * a #GsApp in different parts of vstore can be observed by connecting to
...
gs_app_class_init (GsAppClass *klass)
{
	 ...
	 * GsApp:special-kind:
	 *
	 * vstore specific occupation of the #GsApp entity
...
/**
 * gs_app_new:
 * @id: an application ID, or %NULL, e.g. "org.vaxp.vstore.desktop"
 *
 ...
 *	`system/flatpak/gnome/desktop/org.vaxp.vstore.desktop/master`
 *
