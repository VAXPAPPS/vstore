...
main (int argc, char **argv)
{
	...
	tmp_root = g_dir_make_tmp ("vstore-core-test-XXXXXX", NULL);
	...
	g_test_add_data_func ("/vstore/plugins/core/search-repo-name",
			      plugin_loader,
			      (GTestDataFunc) gs_plugins_core_search_repo_name_func);
	g_test_add_data_func ("/vstore/plugins/core/os-release",
			      plugin_loader,
			      (GTestDataFunc) gs_plugins_core_os_release_func);
	g_test_add_data_func ("/vstore/plugins/core/generic-updates",
			      plugin_loader,
